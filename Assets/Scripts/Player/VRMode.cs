...
public class VRMode : MonoBehaviour
{
    ...
    // camera and stored.
    private const float _defaultFieldOfView = 100.0f;
    [SerializeField]
    public GameObject VrGroup;
    [SerializeField]
    XRCardboardInputModule vrInputModule = default;
    //[SerializeField]
    //DescriptionManager descriptionGroup = default;
    [SerializeField]
    CameraController cameraController = default;
    [SerializeField]
    public GameObject descriptionScrollable = default;
    ...
    public void Start()
    {
        ...
        */
        ...
        // checks if VR mode is enable on start
        // invoke SetObjects(true) if enabled
        // otherwise default setting will load on start
        if (isVrModeEnabled)
        {
            SetObjects(true);
        }
    ...
    void OnVrDisable()
    {
        ...
        _mainCamera.transform.localEulerAngles = new Vector3(0,0,0);
    ...
    void SetObjects(bool vrActive)
    {
        ...
        cameraController.enabled = !vrActive;
        descriptionScrollable.SetActive(!vrActive);
    }
}
